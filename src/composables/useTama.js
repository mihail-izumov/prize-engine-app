...
export const TAMA_PHRASES = {
  ...
  return_done: [
    '+{amount} вернулись. Норм.',
    'Возврат {amount}⚡. Хорошо.',
    'Вернул в заряды. Плюс {amount}⚡.',
    '{amount}⚡ обратно. Гибко.',
  ],
  first_received: [
  ...
  power_insufficient: [
    'Нужно {cards_need}. Сейчас {cards_have}.',
    'Не хватает карт. {cards_have} из {cards_need}.',
    'Ещё {cards_need} штук в комплект.',
  ],
  ...
  expiry_warning: [
    'Через {days_away} дн. сгорят {amount}⚡. Зайди потратить.',
    'Заряды истекают через {days_away} дн.: {amount}⚡.',
    '{amount}⚡ сгорят через {days_away} дн. Используй.',
  ],
  ...
  charges_1k: [
    'Тысяча накопилась. За всё время.',
    'За всё — 1000⚡. Норм старт.',
    'Тысяча в сумме. Уже масштаб.',
  ],
  charges_5k: [
    'Пять тысяч в сумме. Можно крутые подарки.',
    'За всё — 5000⚡. Уже серьёзно.',
    'Накопил пятёрку. Хорошо.',
  ],
  charges_10k: [
    'Десять тысяч за всё. Открыты все варианты.',
    '10000⚡ в сумме. Это уровень.',
    'Достиг десятки. Так держать.',
  ],
